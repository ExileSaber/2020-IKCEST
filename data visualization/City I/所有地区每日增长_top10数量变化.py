...
plt.title('I城市各区域每日增长人数')
plt.savefig(r'D:\python\venv\2020year\2020 IKCEST\data visualization\Plot\city_I\I城市各区域每日增长人数')
plt.show()
print('=================')
...
plt.title('I城市Top10区域每日增长人数')
plt.savefig(r'D:\python\venv\2020year\2020 IKCEST\data visualization\Plot\city_I\I城市Top10区域每日增长人数')
plt.show()
