...
files = ['city_A', 'city_B', 'city_C', 'city_D', 'city_E', 'city_F', 'city_G', 'city_H', 'city_I', 'city_J', 'city_K']
...
print(the_list)
np.save(file="All_city_to_city.npy", arr=the_list)
