...
plt.title('G城市各区域增长数')
plt.savefig(r'D:\python\venv\2020year\2020 IKCEST\data visualization\Plot\city_G\G城市各区域增长数')
plt.show()
print('=================')
...
x = range(len(days))
plt.xticks(x, days, rotation=90)
plt.title('G城市Top10区域增长数')
plt.savefig(r'D:\python\venv\2020year\2020 IKCEST\data visualization\Plot\city_G\G城市Top10区域增长数')
plt.show()
print('=================')
