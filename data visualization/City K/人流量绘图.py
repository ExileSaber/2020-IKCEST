...
for i in range(shape[2]):
    ...
    if i == 0:
        plt.title('K城市区域人流量总数')
        plt.savefig(
            r'D:\python\venv\2020year\2020 IKCEST\data visualization\Plot\city_K\K城市区域人流量总数')
    else:
        plt.title('K城市区域人流量平均数')
        plt.savefig(
            r'D:\python\venv\2020year\2020 IKCEST\data visualization\Plot\city_K\K城市区域人流量平均数')
    plt.show()
...
plt.xticks(x, days, rotation=60)
plt.title('K城市top10区域人流量总数')
plt.savefig(
    r'D:\python\venv\2020year\2020 IKCEST\data visualization\Plot\city_K\K城市top10区域人流量总数数')
plt.show()
...
plt.xticks(x, days, rotation=60)
plt.title('K城市top10区域人流量平均数')
plt.savefig(
    r'D:\python\venv\2020year\2020 IKCEST\data visualization\Plot\city_K\K城市top10区域人流量平均数')
plt.show()
